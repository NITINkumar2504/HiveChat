    ...
    <footer className="shrink-0 border-t border-border px-1.5 pb-2 pt-2 sm:px-2">
      ...
      <div className="mx-auto flex w-full max-w-full items-end gap-1.5 px-0.5 sm:gap-2 sm:px-1">
        <input
          ...
          accept="image/*,video/*"
          className="sr-only"    
          // sr-only stands for "Screen Reader Only." It is an accessibility utility class used to visually hide an element from sighted users while keeping it completely accessible to screen readers and assistive technologies.
          // If you hide an element using standard display utilities like hidden (display: none) or invisible (visibility: hidden), the element is entirely removed from the accessibility tree. This means screen readers will ignore it completely.
